...
<header>
    <div class="header-content">
        <div class="container">
            <h1 class="page-header">Cultural Attractions
            </h1>
            <?php include('ca_server.php'); ?>
                <form action="culture.php" method="post" novalidate="novalidate">
                    <div class="row">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                        <div class="form-group">
                            <input type="text" class="form-control" name="city" id="lname" placeholder="Enter City" required>
                        </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <input type="text" class="form-control" name="ca" id="lname" placeholder="Enter Cultural Park" required>
                            </div>
                        </div>
                    <div class="row">
                        <div class="col-sm-3">
            ...
            <table class="table table-bordered table-striped" style="background-color: black, color:black, position: absolute">
                <tr>
                    ...
                    <th style = "text-align:center">Average Year of Buildings</th>
