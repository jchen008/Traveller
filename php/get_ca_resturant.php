...
<html>
    ...
    <body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        Try Value: Buckingham Palace, and it will return the resturants locate in the park
                        <hr> 
                        <small>Empty Input will return all resturants in all cultural attractions</small>
                    </h1>
                </div>
            </div>
        </div>
        ...
        <div class="container" >
            <form action="get_ca_resturant.php" method="post">
